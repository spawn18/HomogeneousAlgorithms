...
def average(q):
    results = mishin_localnconvex_grad.minimize(functions.funcs, grad_smoother=lambda x: grad1(x, 0.25, 0.4), exponent=q)
...
ax.set_xlabel('Показатель роста')
